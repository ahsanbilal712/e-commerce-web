// src/app/cart/components/CartPageBody.tsx
"use client";
        ...
        <div className="max-w-full mx-auto p-10 bg-white">
            <div className="flex justify-center flex-col py-2">
                <div className="text-sm font-sans mx-auto flex flex-row">
                    <AiOutlineStop className="text-red-600 mr-2" />
                    <span>Please, hurry! Someone has placed an order on one of the items you have in the cart. Products are limited, checkout within 44:28 s</span>
                </div>
